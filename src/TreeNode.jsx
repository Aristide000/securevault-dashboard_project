function TreeNode({ node, selectedId, focusedId, openIds, onSelect, 
  onFocus, onToggle, searchQuery, levelSiblings, parentMatches }) {
...
const isFolder = node.type === 'folder'
 const isSelected = node.id === selectedId
  ...
  const isVisible = parentMatches || !searchQuery || matchesSearch || 
